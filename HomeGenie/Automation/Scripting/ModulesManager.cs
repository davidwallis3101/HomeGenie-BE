// <copyright file="ModulesManager.cs" company="Bounz">
...
namespace HomeGenie.Automation.Scripting
{
    ...
    public class ModulesManager
    {
        ...
        private string withName = string.Empty;
        private string ofDeviceType = string.Empty;
        private string inGroup = string.Empty;
        private string inDomain = string.Empty;
        private string withAddress = string.Empty;
        private string withParameter = string.Empty;
        private string withFeature = string.Empty;
        private string withoutFeature = string.Empty;
        ...
        public ModulesManager Each(Func<ModuleHelper, bool> callback)
        {
            ...
            {
                if (callback(new ModuleHelper(homegenie, module)))
                {
                    break;
                }
            }
        ...
        public virtual TsList<Module> SelectedModules
        {
            get
            {
                ...
                for (int cm = 0; cm < Modules.Count; cm++)
                {
                    ...
                    bool selected = true;
                    if (selected && this.inDomain != null && this.inDomain != string.Empty && GetArgumentsList(this.inDomain.ToLower()).Contains(module.Domain.ToLower()) == false)
                    {
                        selected = false;
                    }

                    if (selected && this.withAddress != null && this.withAddress != string.Empty && GetArgumentsList(this.withAddress.ToLower()).Contains(module.Address.ToLower()) == false)
                    {
                        selected = false;
                    }

                    if (selected && this.withName != null && this.withName != string.Empty && GetArgumentsList(this.withName.ToLower()).Contains(module.Name.ToLower()) == false)
                    {
                        selected = false;
                    }

                    if (selected && this.withParameter != null && this.withParameter != string.Empty)
                    {
                    ...
                    if (selected && this.withFeature != null && this.withFeature != string.Empty)
                    {
                    ...
                    if (selected && this.withoutFeature != null && this.withoutFeature != string.Empty)
                    {
                    ...
                    if (selected && this.inGroup != null && this.inGroup != string.Empty)
                    {
                        selected = false;
                    ...
                    if (selected && this.ofDeviceType != null && this.ofDeviceType != string.Empty)
                    {
                        selected = false;
        ...
        public object GetValue(string options = "")
        {
            ...
            if (command != string.Empty && selectedModules.Count > 0)
            {
        ...
        public ModulesManager Reset()
        {
            ...
            ofDeviceType = string.Empty;
            inGroup = string.Empty;
            inDomain = string.Empty;
            withAddress = string.Empty;
            withParameter = string.Empty;
            withFeature = string.Empty;
            iterationDelay = 0;
            return this;
        }
