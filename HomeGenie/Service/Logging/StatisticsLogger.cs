// <copyright file="StatisticsLogger.cs" company="Bounz">
            ...
            DateTime endDate)
        {
            ...
            while (reader.Read())
            {
                ...
                catch
                {
                    ...
                    {
                        double.TryParse(reader.GetString(4), out entry.Value);
                    }
                }
            ...
            DateTime endDate)
        {
            ...
            while (reader.Read())
            {
                ...
                catch
                {
                    ...
                    if (value != DBNull.Value && value != null)
                    {
                        double.TryParse(reader.GetString(5), out entry.Value);
                    }
                }
