            ...
            switch (migCommand.Command)
            {
                ...
                case "System.Configure":
                {
                            ...
                            if (File.Exists(relInfo))
                            {
                                ...
                                if (updateRelease.ReleaseDate >= currentRelease.ReleaseDate)
                                {
                                    ...
                                    if (installStatus != InstallStatus.Error)
                                    {
                                        ...
                                        {
                                            homegenie.RaiseEvent(Domains.HomeGenie_System, Domains.HomeGenie_System, SourceModule.Master, "HomeGenie System",
                                                Properties.HomeGenieStatus, "UPDATED");
                                            Thread.Sleep(3000);
                                        }
                                    }
                                }
                    ...
                    else if (migCommand.GetOption(0) == "SystemLogging.DownloadCsv")
                    {
                        ...
                        (request.Context.Data as HttpListenerContext).Response.AddHeader("Content-Disposition",
                    ...
                    else
                    {
                        ...
                        foreach (var newParameter in newModule.Properties)
                        {
                            ...
                            if (currentParameter == null)
                            {
                                ...
                                homegenie.RaiseEvent(Domains.HomeGenie_System, currentModule.Domain, currentModule.Address, currentModule.Description, newParameter.Name,
                                    newParameter.Value);
                            }
                            else if (newParameter.NeedsUpdate)
                            {
                                ...
                                {
                                    homegenie.RaiseEvent(Domains.HomeGenie_System, currentModule.Domain, currentModule.Address, currentModule.Description, Properties.MeterWatts,
                                        "0.0");
                                }
