// <copyright file="MigEvent.cs" company="Bounz">
...
namespace MIG
{
    ...
    public class MigEvent
    {
        ...
        public override string ToString()
        {
            ...
            string logentrytxt = this.Domain + "\t" + this.Source + "\t" + (this.Description == string.Empty ? "-" : this.Description) + "\t" + this.Property + "\t" + this.Value;
            return logentrytxt;
        }
    }
}
